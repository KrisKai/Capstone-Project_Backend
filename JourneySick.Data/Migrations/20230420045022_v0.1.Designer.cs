            ...
            modelBuilder.Entity("JourneySick.Data.Models.Entities.trip", b =>
                {
                    ...
                    b.Property<DateTime?>("EstimateArrivalTime")
                        .HasColumnType("datetime")
                        .HasColumnName("EstimateArrivalTime");
                    ...
                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("TripName"), "utf8");
                    ...
                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("TripStatus"), "utf8");
            ...
            modelBuilder.Entity("JourneySick.Data.Models.Entities.tripdetail", b =>
                {
                    ...
                    b.Property<string>("TripDestinationLocationAddress")
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)")
                        .HasColumnName("TripDestinationLocationAddress")
                        .UseCollation("utf8_general_ci");

                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("TripDestinationLocationAddress"), "utf8");

                    b.Property<string>("TripDestinationLocationName")
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)")
                        .HasColumnName("TripDestinationLocationName")
                        .UseCollation("utf8_general_ci");

                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("TripDestinationLocationName"), "utf8");

                    b.Property<string>("TripStartLocationAddress")
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)")
                        .HasColumnName("TripStartLocationAddress")
                        .UseCollation("utf8_general_ci");

                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("TripStartLocationAddress"), "utf8");

                    b.Property<string>("TripStartLocationName")
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)")
                        .HasColumnName("TripStartLocationName");
                    ...
                    b.HasIndex(new[] { "TripId" }, "TripId_UNIQUE1")
                        .IsUnique();
            ...
            modelBuilder.Entity("JourneySick.Data.Models.Entities.userdetail", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("Address"), "utf8");
                    ...
                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("Role"), "utf8");
                    ...
                    b.HasIndex(new[] { "UserId" }, "UserId_UNIQUE1")
                        .IsUnique();
